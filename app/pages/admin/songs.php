...
if ($action == 'add') {
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (empty($errors)) {
            ...
            $values['album_id'] = $existing_album['id'];
    ...
    $total_rows_query = "SELECT COUNT(*) as total FROM songs";
    $total_rows = db_query_one($total_rows_query)['total'];
