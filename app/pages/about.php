    ...
    <div class="about-content">
        <div class="about-section">
            <div class="about-image">
                <img src="<?=ROOT?>/assets/images/abtU.png" alt="SoundWave Music">
            </div>
            ...
            <div class="team-grid">
                <div class="team-member">
                    <div class="member-photo">
                        <img src="<?=ROOT?>/assets/images/micro.jpg" alt="Team Member">
                    </div>
                ...
                <div class="team-member">
                    <div class="member-photo">
                        <img src="<?=ROOT?>/assets/images/note.png" alt="Team Member">
                    </div>
                    <div class="member-info">
                        <h3>Jane Smith</h3>
                ...
                <div class="team-member">
                    <div class="member-photo">
                        <img src="<?=ROOT?>/assets/images/headphone.jpg" alt="Team Member">
                    </div>
                    <div class="member-info">
