...
$row = db_query_one($query, ['id' => $user_id]); // Không cần truyền $conn
...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if(empty($errors))
    {
        ...
        if(!empty($_POST['password']))
        {
            ...
            db_query($query, $values); // Không cần truyền $conn

            // Cập nhật thông tin session
            $new_data = db_query_one("select * from users where id = :id limit 1", ['id' => $user_id]); // Không cần truyền $conn
            if($new_data) {
        ...
        <div class="profile-sidebar">
            <div class="profile-card">
                <div class="user-avatar">
                    <?php
                    // Giả sử $row chứa thông tin của người dùng, bao gồm trường 'avatar'
                    $avatar = !empty($row['avatar']) ? $row['avatar'] : ROOT . '/assets/images/img_avartar_user_default.jpg';
                    ?>
                ...
                <div class="profile-card-body">
                    <div class="user-info-item">
                        ...
                        <div class="user-info-text">
                            ...
                            <div class="user-info-value"><?=number_format(getUserBalance($user_id), 0, ',', '.')?> đồng
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="<?=ROOT?>/deposit" method="post" class="profile-form">
                        <div class="input-group">
                            ...
                            <input type="number" id="amount" name="amount" class="form-control" min="10000" step="10000"
                                value="10000">
                        </div>
                    ...
                    <div class="profile-card-body">
                        ...
                        <form method="post" class="profile-form">
                            <div class="input-group">
                                ...
                                <input type="text" id="username" class="form-control form-control-readonly"
                                    value="<?=esc($row['username'])?>" readonly>
                            </div>

                            <div class="input-group">
                                <label for="email">Email <span class="info-badge">Chỉ xem</span></label>
                                <input type="email" id="email" class="form-control form-control-readonly"
                                    value="<?=esc($row['email'])?>" readonly>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <small class="error"><i class="fas fa-exclamation-circle"></i>
                ...
                <div class="profile-card">
                    ...
                    <div class="profile-card-body">
                        ...
                        <p style="margin-top: 20px; color: #666; font-size: 14px;">
                            <i class="fas fa-info-circle"></i> Nếu bạn muốn thay đổi tên người dùng hoặc email, vui lòng
